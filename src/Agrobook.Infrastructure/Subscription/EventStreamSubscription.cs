...
namespace Agrobook.Infrastructure.Subscription
{
    public class EventStreamSubscription : IEventStreamSubscription
    {
        ...
        public EventStreamSubscription(IEventStoreConnection resilientConnection, string streamName, Lazy<long?> lastCheckpoint, Action<long, object> handler, TimeSpan stopTimeout)
        {
